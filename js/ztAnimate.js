(function () {
    ...
    //->setGroupCss:批量设置某个元素的样式
    function setGroupCss(curEle, obj) {
        for (var key in obj) {
            if (obj.hasOwnProperty(key)) {//->为了防止在遍历的时候,把自己在内置类原型上扩展的那些公有的属性和方法也遍历到(原型上内置的属性和方法是属于不可枚举的,遍历的时候遍历不到)
    ...
    var ztEffect = {
        ...
        Bounce: {
            easeIn: function (t, b, c, d) {
                return c - ztEffect.Bounce.easeOut(d - t, 0, c, d) + b;
            },
            ...
            easeInOut: function (t, b, c, d) {
                if (t < d / 2) {
                    return ztEffect.Bounce.easeIn(t * 2, 0, c, d) * .5 + b;
                }
                return ztEffect.Bounce.easeOut(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
            }
        },
        //二次方的缓动
        Quad: {
    ...
    function animate(curEle, tarObj, duration, effect) {
        ...
        if (typeof effect === "number") {
            ...
            for (var i = 0; i < ary.length; i++) {
                if (effect === (i + 1)) {
                    ...
                    fnEffect = curItem.length === 1 ? ztEffect[curItemFir] : ztEffect[curItemFir][curItemTwo];
                    break;
                }
            }
            ...
            fnEffect = effect.length === 1 ? ztEffect[effectFir] : ztEffect[effectFir][effectTwo];
        }
        ...
        ztEvent.fire.call(curEle, "ztAnimateStart");
        ...
        curEle.timer = window.setInterval(function () {
            ...
            if (times >= duration) {
                ...
                ztEvent.fire.call(curEle, "ztAnimateEnd");
                return;
            }
